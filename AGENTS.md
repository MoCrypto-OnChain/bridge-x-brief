...
**Cross-repo context:** This repo is part of the wider Bridge X Capital stack (see `BRIDGE-X-PLATFORM-CONTEXT.md` in this repo root for full platform context, design system, and prior incident history across other repos).
